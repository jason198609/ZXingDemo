...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	protected void onResume() {
		...
		if (intent != null) {
			...
			if (Intents.Scan.ACTION.equals(action)) {
				...
				Log.e("inputUri", inputUri.toString() + "--");
	...
	// } else if (points.length == 4 && (rawResult.getBarcodeFormat() ==
	...
	private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
		...
		// }
		String data = displayContents.toString();
		if (!TextUtils.isEmpty(data)) {
			if (data.startsWith("mantun")) {
				startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("mantun://123123123")));
		...
		if (resultHandler.getDefaultButtonID() != null && prefs.getBoolean(PreferencesActivity.KEY_AUTO_OPEN_WEB, true)) {
